...
export default function CatalogoPage() {
    ...
    return (
      <div className="min-h-screen bg-[#020202] flex items-center justify-center">
         <motion.div 
           ...
           className="relative text-[#c28c28]"
         >
           <FaGem className="text-4xl drop-shadow-[0_0_15px_rgba(179,148,91,0.5)]" />
           <div className="absolute inset-0 blur-lg bg-[#c28c28]/40" />
         </motion.div>
      </div>
    );
  }
  ...
  return (
    <div className={`min-h-screen bg-[#020202]/0 text-[#E0E0E0] relative overflow-hidden selection:bg-[#c28c28]/30 ${cinzel.variable} ${cormorant.variable} font-serif`}>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[60%] h-[40%] bg-[#c28c28] rounded-full blur-[180px] opacity-[0.08]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-24 pt-12">
        ...
        <div className="text-center mb-16">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-[#c28c28] text-xs uppercase font-bold mb-4" style={{ fontFamily: 'var(--font-cinzel)' }}>
            Colección Sagrada
          </motion.p>
          ...
          <div className="h-[1px] w-24 bg-gradient-to-r from-transparent via-[#c28c28] to-transparent mx-auto mb-6" />
        </div>
        ...
        <div className="mb-16 flex flex-col items-center gap-8">
            ...
            <div className="relative group w-full max-w-md">
              <div className="absolute inset-y-0 left-0 flex items-center pointer-events-none text-[#c28c28]/50 pl-2">
                <FaSearch />
              </div>
              <input 
                type="text" 
                placeholder="Invocar artefacto..." 
                className="w-full bg-transparent border-b border-[#333] text-[#E0E0E0] pl-10 pr-4 py-3 focus:outline-none focus:border-[#c28c28] transition-colors placeholder-[#444]"
            ...
            <div className="w-full max-w-5xl flex items-center justify-center gap-4">
                ...
                <button
                    ...
                    activeCategory === "Todos" 
                        ? "text-[#c28c28] border-[#c28c28]/30 bg-[#c28c28]/5" 
                        : "text-[#666] hover:text-[#c28c28]"
                    }`}
                ...
                <div className="relative group/scroll overflow-hidden flex-1">
                    ...
                    <div className="flex overflow-x-auto gap-2 pb-2 scrollbar-hide snap-x items-center">
                        ...
                        >
                            ...
                            <motion.div 
                                layoutId="activeCat"
                                className="absolute bottom-0 left-0 w-full h-[1px] bg-[#c28c28] shadow-[0_0_10px_#c28c28]"
                            />
                            )}
                        </button>
                        ))}
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-32 opacity-50 flex flex-col items-center">
            ...
            <button 
                ...
                className="mt-4 text-[#c28c28] text-sm hover:underline"
            >
                Restaurar visión
            </button>
          </div>
